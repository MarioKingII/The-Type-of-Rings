...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = 'INFO.json'
storage_client = storage.Client()

bucket_name = 'game1data1'
...
response = upload_to_bucket('requirement', r'C:\Users\black\OneDrive\Desktop\Projects\python\Cloud data base\cloudstorge.py\text.txt', bucket_name)
...
# download_file_from_bucket('requirement', 'test.txt', bucket_name)
